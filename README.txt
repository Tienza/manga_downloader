...
4. Retrieve the downloaded img_sources.txt file and move it into the same directory as "webpage_image_downloader.sh"
5. Run the following command in a unix/linux terminal ./webpage_image_downloader.sh [-r] <output file name>.pdf
